...
import { connectFirebase as connect } from '../../src/index'

// this is nearly unmodified spec from react-redux's connect to ensure that
// connectFirebase works as a drop-in replacement for connect

// based on:
// https://github.com/rackt/react-redux/blob/a2dff763dd9a325cdc437bce974f01c5c0f6df45/test/components/connect.spec.js

// changes:

// should set the displayName correctly
// changed Connect() -> Connect(ConnectFirebase())

// should pass state consistently to mapState
// added extra getWrappedInstance() call to get proper ref

// should return the instance of the wrapped component for use in calling child methods
// added extra getWrappedInstance() calls for proper refs
...
describe('React', () => {
  describe('connect', () => {
    ...
    it('should set the displayName correctly', () => {
      ...
      ).displayName).toBe('Connect(ConnectFirebase(Foo))')
      ...
      ).displayName).toBe('Connect(ConnectFirebase(Bar))')
      ...
      ).displayName).toBe('Connect(ConnectFirebase(Component))')
    })
    ...
    it('should return the instance of the wrapped component for use in calling child methods', () => {
      ...
      expect(decorated.getWrappedInstance().getWrappedInstance().someInstanceMethod()).toBe(someData)
      expect(decorated.getWrappedInstance().refs.wrappedInstance.someInstanceMethod()).toBe(someData)
    })
    ...
    it('should pass state consistently to mapState', () => {
      ...
      const container = TestUtils.findRenderedComponentWithType(tree, Container)
      const node = container.getWrappedInstance().getWrappedInstance().refs.button
